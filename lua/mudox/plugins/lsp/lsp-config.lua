...
local function setup_formatting()
  -- setup autoformat
  require("mudox.plugins.lsp.format").autoformat = opts.autoformat
  -- setup formatting and keymaps
  require("mudox.lib").on_attach(function(client, buffer)
    require("mudox.plugins.lsp.format").on_attach(client, buffer)
    require("mudox.plugins.lsp.keymaps").on_attach(client, buffer)
  end)
end
