...
local keys = {
  -- session
  { "<F5> ✓",  function() d().continue() end,                           "Continue",                       },
  ...
  -- stepping
  { "<F10> ✓", function() d().step_over() end,                          "Step over",                      },
  { "<F11> ✓", function() d().step_into() end,                          "Step into",                      },
  { "<F12> ✓", function() d().step_out() end,                           "Step out",                       },
  ...
  -- breakpoint
  { "<F4> ✓",  function() d().toggle_breakpoint() end,                  "Toggle breakpoint",              },
