...
local keys = {
  -- session
  { "<F5>",             function() d().continue() end,                           "[DAP] Continue"              },
  { ".",                function() d().run_last() end,                           "[DAP] Run last"              },
  { "r",                function() d().restart() end,                            "[DAP] Restart"               },
  { "q",                function() d().terminate() end,                          "[DAP] Quit"                  },

  -- stepping
  { "<F10>",            function() d().step_over() end,                          "[DAP] Step over"             },
  { "<F11>",            function() d().step_into() end,                          "[DAP] Step into"             },
  { "<F12>",            function() d().step_out() end,                           "[DAP] Step out"              },
  { "U",                function() d().step_back() end,                          "[DAP] Step back"             },
  ...
  -- breakpoint
  { "<F4>",             function() d().toggle_breakpoint() end,                  "[DAP] Toggle breakpoint"     },
  ...
  -- ui
  { "<leader>d<Space>", function() u().toggle {} end,                            "[DAPUI] Toggle panels"       },
